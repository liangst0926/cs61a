...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        ...
        gcd = math.gcd(player_score, opponent_score)
        if gcd >= 10:
            return True
        else:
            return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            player0_gain = take_turn(player0_num_dice, score1, dice)
            score0 += player0_gain
            ...
            player1_gain = take_turn(player1_num_dice, score0, dice)
            score1 += player1_gain
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if current_gain > running_high:
                print(current_gain, 'point(s)!', 'The most yet for Player 0')
                return announce_highest(who, score0, current_gain)
            else:
                return announce_highest(who, score0, running_high)
        else:
            current_gain = score1 - last_score
            if current_gain > running_high:
                print(current_gain, 'point(s)!', 'The most yet for Player 1')
                return announce_highest(who, score1, current_gain)
            else:
