...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        counter = 0
        while True:
            if temp_place == beehive:
                return None
            if rANTdom_else_none(temp_place.bees) != None and self.min_range <= counter <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for elem in bees_copy:
            Insect.reduce_armor(elem, reflect_damage)
    ...
    def action(self, gamestate):
        ...
        if self.real_queen:
            ...
            while True:
                if temp_place == None:
                    break
                elif temp_place.ant != None and temp_place.ant.buffed == False:
                    temp_place.ant.buffed = True
